        ...
        <div class="col-sm-6">
          <div class="a-section">
            ...
            <form>
              ...
              <!-- Title Dropdown -->
              <div class="a-spacing-top-medium">
                <label style="margin-button: 0px;">Title</label>
                <input
                  type="text"
                  class="a-input-text"
                  style="width: 100%"
              ...
              <!-- Price input -->
              <div class="a-spacing-top-medium">
                <label style="margin-button: 0px;">Price</label>
                <input
                  type="number"
                  class="a-input-text"
                  style="width: 100%"
              ...
              <!-- Stock input -->
              <div class="a-spacing-top-medium">
                <label style="margin-button: 0px;">Stock Quantity</label>
                <input
                  type="number"
                  class="a-input-text"
                  style="width: 100%"
              ...
              <!-- photo file -->
              <div class="a-spacing-top-medium">
                <label style="margin-button: 0px;">Add photo</label>
